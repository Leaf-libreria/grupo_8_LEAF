INSERT INTO stars (quantity) VALUES (1), (2), (3),
(4),(5);

INSERT INTO formats (name) VALUES ('Libro'), ('E-book');

INSERT INTO categories (name) VALUES ('Más vendidos'), ('Novedades'), 
('Recomendados');

INSERT INTO genres (name) VALUES ('Policial'), ('Historica'),
 ('Ciencia-ficcion'), ('Romance'), ('Misterio'),
 ('Juvenil'),('Terror'),('Thriller'),('Fantasia');
 
 INSERT INTO editorials (name) VALUES ('Plaza & Janés'),
 ('B de bolsillo'), ('Granica'),
('Suma'), ('Booket'),
('Puck'), ('Wattpad'),
('Ediciones Urano'), ('Penguin random house'),
('Ediciones B'), ('Montena'),
('Planeta'), ('Sudamericana'),('Martínez Roca'),
('Hidra'), ('Alianza'),
('Ediciones Akal'), ('De Bolsillo') ;


INSERT INTO authors (nameLastname) VALUES ( 'John Grisham'),
( 'John Katzenbach'),
('Markus Zusak'),
('H. G. Wells'),
('Florencia Bonelli'),
...
('Angel David Revilla'),
('Leigh Bardugo'),
('Emily Jane Brontë'),('Arthur Conan Doyle');

INSERT INTO books (title, isbn, stock, price, slogan, pages, synopsis, authorId, genreId, formatId, categoryId, editorialId, starId, cover)
 VALUES ('El manuscrito',9789506445584, 100, 1500,'¡Llega la esperadísima novela del maestro de los thrillers policiales y judiciales!',
 ...
 ('El psicoanalista', 9789876278270, 150, 2100,'Novela que lanzo a la fama a John Katzenbach',
 ...
 ('La ladrona de libros', 9788499088075, 98,1900, 'Una novela preciosa, tremendamente humana y emocionante, que describe las peripecias de una niña alemana de nueve años desde que es dada en adopción por su madre hasta el final de la II Guerra Mundial.',
 ...
 ('La guerra de los mundos',9789563164411,47,2400,'¡Obra maestra de la Ciencia Ficción!',
 ...
 ('La tía Cósima',9789877391480,85,2000,'¿Puede el amor regalar una segunda oportunidad?',
 ...
 ('Al final mueren los dos', 9789874132017,185,1500,'¿Puede un solo día albergar toda una vida?',
 ...
 ('Yo antes de ti', 9789870434665,65,3000,'Una historia que necesitas experimentar.',
 ...
 ('La sombra del viento',9789504956068, 80, 3100,'No te puedes perder esta saga, es una de las más grandes series de la novela contemporánea española',
 ...
 ('A la caza de Houdini', 9789877391480, 100, 1800,'Un asesino termina con la vida de los pasajeros uno por uno… y no hay lugar adonde escapar',
 ...
 ('A traves de mi ventana', 9789877391480, 64,1750, 'Llega la novela fenómeno de Wattpad',
 ...
 10, 6, 2, 3, 7, 3,'a-traves-de-mi-ventana.jpg'),
 ('El teorema de júpiter', 9788416327652, 255, 1400, 'Una historia de amor, que va tomando retazos importantes de una vida compartida y a la vez hecha de diferentes perspectivas y que se nutre de cada sabiduría.',
 ...
 ('Luna I En la oscuridad', 9789585986619, 196, 2000, 'La primera entrega de una trilogía que promete al lector, fantasía, misterio e intriga en altas dosis...',
 ...
 ('Personas Desconocidas',9789588991269, 200,2870,'Katzenbach nos ofrece un thriller de ritmo imparable, protagonistas convincentes y trama compleja pero fascinante al mismo tiempo.', 475,
 ...
 ('Desesperación', 9789877391480,74,3100,'Presenta muchas características habituales en la bibliografía del autor, como la lucha por la supervivencia, el enfrentamiento entre el bien y el mal, su naturaleza fantástica y un grupo de personajes variopintos protagonistas de la historia...',
 ...
 ('El despertar de la sirena',9789585951099, 120, 1500, 'El mar está lleno de peligros. Algunos son conocidos para el hombre... y otros no',
...
('Los hijos de nuestros hijos', 9789504935648, 150,1900,'Dicen que vienen del futuro. Son los hijos de nuestros hijos.',
...
('Veronica decide morir', 9789504935605, 140, 2000, 'Sueños y fantasías. Deseo y muerte. Locura y pasión',
...
('El retrato de Dorian Gray', 9789500755955, 200, 3200, 'Un libro lleno de fascinación y encanto, fácil y difícil a la vez, y cuyo único protagonista y tema esencial es la belleza. Una de las pasiones que hacen vivir, dan sentido y fuerza al mundo.',
...
('Despues', 9789506445614, 100, 2600, 'Nació con una habilidad sobrenatural que su madre le insta a mantener en secreto y que le permite ver aquello que nadie puede y enterarse de lo que el resto del mundo ignora',
...
('El libro negro', 9789508701534, 100, 2400, 'El universo se vuelve escalofriante cuando la vida se bifurca. Vuelve Dross con su primer libro de cuentos.', 
...
('Sombra y hueso', 9788418002526, 150, 2000, 'Sombra y Hueso es una aventura de fantasía, y novela de debut escrita por Leigh Bardugo.',
...
('Asedio y tormenta', 9788415709367, 140, 2500, 'Llega la esperada continuación de Sombra y hueso.',
...
19, 9, 1, 2, 15, 5,'default-image-book.png'),
('Ruina y ascenso', 9788415709374, 160, 2700, 'Al fin llega la conclusión de la trilogía Sombra y hueso.',
...
('Cumbres borrascosas', 9788491819431, 194, 3100, 'Melancólico relato sobre el amor más allá de la muerte, la rivalidad entre hermanos y la venganza.',
...
('El Sabueso de los Baskerville', 9798542961620, 190, 2200, 'Un caso que lleva al límite de lo racional el talento detectivesco de Sherlock Holmes y su infatigable compañero, el Doctor Watson.',
